...
class MLThreatClassifier:
    ...
    def classify(cls, text: str, sender: str = "", subject: str = "") -> Dict[str, Any]:
        ...
        # 3. Urgency & Social Engineering Vector
        urgency_hits = []
        ...
        # 4. Domain & Sender Lexical Analysis
        ...
        # Check sender display name vs address disparity (Executive Impersonation)
        if '"' in sender or "'" in sender or "<" in sender:
            ...
            # If display name contains common titles or names but address is generic or disposable
...
class RiskEngine:
    ...
    def calculate_risk(
        ...
        total_score = min(100, ml_score + auth_risk + infra_risk + behavior_bec_risk + lookalike_risk + identity_risk + disposable_risk)

...
async def analyze_email(
    ...
    for idx, r_header in enumerate(received_headers):
        ...
        hops.append({
            "hop": idx + 1,
            "raw": r_header[:250].strip(),
            "ips": ips
        })

    # 4. Earliest observable public IP and Authoritative Enrichment
    probable_origin_ip = None
    ip_intel = {}
    if observable_public_ips:
        probable_origin_ip = observable_public_ips[-1]
